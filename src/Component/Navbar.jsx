    ...
    export const Navbar = () =>{
        return <motion.nav className='navbar' initial={{y:-100}} animate = {{y:0}} transition={{duration:0.6 , ease:"easeOut"}}>
            ...
            <motion.div className='logo' whileHover={{scale:1.05}} whileTap={{scale:0.95}} >Protfolio</motion.div>
            <motion.ul className='nav-links' variants={straggerChildren} initial="inital" animate="animate">
                <motion.li 
